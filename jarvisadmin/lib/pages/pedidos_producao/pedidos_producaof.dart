...
import 'package:jarvisadmin/pages/pedidos_producao/pedidos_producao_controllerf.dart';
import 'package:jarvis_core/core/model/produto_model.dart';
import 'package:jarvis_core/widgets/mp_app_bar.dart';

class PedidosProducaoPagef extends StatefulWidget {
  PedidosProducaoPagef({Key key}) : super(key: key);

  @override
  _PedidosProducaoPageStatef createState() => _PedidosProducaoPageStatef();
}

class _PedidosProducaoPageStatef extends State<PedidosProducaoPagef> {
  final _controller = PedidosProducaoControlerf();
