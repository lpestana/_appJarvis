                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              initialValue:
                                  _controller.produto.tempoPreparo ?? '',
                              decoration: InputDecoration(
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(20),
                                ),
                                labelText: 'Tempo Preparo',
                                hintText: 'Tempo Preparo',
                              ),
                              validator: (tempoPreparo) => tempoPreparo.isEmpty
                                  ? 'Campo Obrigatório'
                                  : null,
                              onSaved: _controller.setTempoPreparoProduto,
                            ),
                          ),
                          SizedBox(height: 12),
                          Container(
